package com.jiangwei.fmodexample;
...
public class MainActivity extends Activity implements OnTouchListener, Runnable {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout.LayoutParams lpLayout =
    ...
    static {
        /*
         * To simplify our examples we try to load all possible FMOD libraries, the Android.mk will copy in the correct
         * ones for each example. For real products you would just load 'fmod' and if you use the FMOD Studio tool you
         * would also load 'fmodstudio'.
         */
